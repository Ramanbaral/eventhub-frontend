      ...
      <Card className="w-full max-w-md shadow-lg">
        ...
        <CardContent>
          <form className="space-y-5" onSubmit={form.handleSubmit(onSubmit)} noValidate>
            <div className="space-y-2">
              ...
              <Input id="email" type="email" autoComplete="email" placeholder="you@example.com" aria-invalid={form.formState.errors.email ? true : undefined} {...form.register('email')} />
              {form.formState.errors.email && <p className="text-sm text-destructive" role="alert">{form.formState.errors.email.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="password">Password</Label>
              <Input id="password" type="password" autoComplete="current-password" placeholder="Enter your password" aria-invalid={form.formState.errors.password ? true : undefined} {...form.register('password')} />
        ...
        <CardFooter className="flex-col gap-4 border-0 bg-background">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <a className="font-medium text-blue-500 underline-offset-4 hover:underline" href="/register">Register here</a>
          </p>
        </CardFooter>
      </Card>
    </main>
